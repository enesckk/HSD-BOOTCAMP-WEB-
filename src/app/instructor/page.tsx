...
const InstructorDashboard = () => {
  ...
  return (
    <InstructorLayout title="Anasayfa" subtitle="HSD Türkiye Bootcamp Eğitmen Paneli">
      <div className="space-y-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              { title: 'Katılımcılar', description: 'Katılımcıları görüntüle ve takip et', icon: Users, href: '/instructor/students', color: 'text-red-600', bgColor: 'bg-red-50' },
              { title: 'Görevler', description: 'Mevcut görevleri görüntüle', icon: Target, href: '/instructor/tasks', color: 'text-red-600', bgColor: 'bg-red-50' },
              { title: 'Dersler', description: 'Ders saatleri ve linkler', icon: BookOpen, href: '/instructor/lessons', color: 'text-red-600', bgColor: 'bg-red-50' },
              { title: 'Mesajlar', description: 'Eğitmen mesajlarını cevapla', icon: MessageSquare, href: '/instructor/questions', color: 'text-red-600', bgColor: 'bg-red-50' },
              { title: 'Duyurular', description: 'Duyuruları görüntüle', icon: Bell, href: '/instructor/announcements', color: 'text-red-600', bgColor: 'bg-red-50' }
            ].map((action, index) => {
              ...
              return (
                <motion.a
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className={`p-4 rounded-xl border border-gray-200 ${action.bgColor} hover:shadow-md transition-all duration-200 group`}
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
